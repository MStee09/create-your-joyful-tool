...
export const GROWTH_STAGES: Record<CropType, GrowthStage[]> = {
  ...
  dry_beans: [
    ...
    { stage: 'V5', description: 'Fifth trifoliate', order: 6 },
    { stage: 'V6', description: 'Sixth trifoliate', order: 7 },
    { stage: 'V7', description: 'Seventh trifoliate', order: 8 },
    { stage: 'V8', description: 'Eighth trifoliate', order: 9 },
    { stage: 'V9', description: 'Ninth trifoliate', order: 10 },
    { stage: 'V10', description: 'Tenth trifoliate', order: 11 },
    { stage: 'R1', description: 'Beginning bloom', order: 12 },
    { stage: 'R2', description: 'Beginning pod (pin bean)', order: 13 },
    { stage: 'R3', description: '50% bloom', order: 14 },
    { stage: 'R4', description: 'Full pod', order: 15 },
    { stage: 'R5', description: 'Beginning seed', order: 16 },
    { stage: 'R6', description: '50% seed', order: 17 },
    { stage: 'R7', description: 'Full seed', order: 18 },
    { stage: 'R8', description: 'Beginning maturity', order: 19 },
    { stage: 'R8.5', description: 'Mid maturity', order: 20 },
